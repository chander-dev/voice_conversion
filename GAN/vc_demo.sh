...
experiment_id=$1
cmu_arctic_dir=$2
data_dir=./features/ #target directory where the np arrays will be stored  
run_training=1                          
...
# Feature extraction
python prepare_features_vc.py --max_files=50 ${cmu_arctic_dir} \
    ksp bdl --dst_dir=${data_dir}
...
python evaluation_vc.py \
    ...
    ${data_dir} \
    ${cmu_arctic_dir}/cmu_us_ksp_arctic/wav \
